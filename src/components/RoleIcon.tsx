...
export type ChatRole = "ADMIN" | "STAFF" | "OWNER" | "MODERATOR" | "MEMBER" | "GUEST";
...
export function chatRole(platformRole: string | undefined, roomRole: string | undefined): ChatRole {
  if (platformRole === "ADMIN") return "ADMIN";
  if (platformRole === "MODERATOR") return "STAFF";
  return (roomRole as ChatRole) || "GUEST";
}

export const CHAT_ROLE_RANK: Record<ChatRole, number> = { ADMIN: 5, STAFF: 4, OWNER: 3, MODERATOR: 2, MEMBER: 1, GUEST: 0 };
