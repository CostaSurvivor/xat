  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4">
      ...
      <section className="card space-y-3 p-5">
        <p className="text-sm text-mute">Troque Pimentas, <b className="text-fg">itens permanentes</b> e dias de assinatura com segurança: cada lado monta a oferta, os dois aceitam e confirmam com a senha. Qualquer mudança zera os aceites.</p>
      ...
      <section className="card divide-y divide-line">
        ...
        {trades.map((t) => {
          ...
          return (
            <Link key={t.id} href={`/trocas/${t.id}`} className="flex items-center gap-3 p-3 text-sm hover:bg-black/5">
