...
export default function Termos() {
  return (
    <article className="prose-invert mx-auto max-w-3xl space-y-4 card p-6 text-sm leading-relaxed text-mute sm:p-10">
      <h1 className="font-[family-name:var(--font-display)] text-3xl font-bold text-white">Termos de Uso</h1>
      <p>Versão {TERMS_VERSION}. Ao usar o {SITE_NAME} você concorda com estes termos.</p>
      <h2 className="text-lg font-semibold text-white">1. Somente maiores de 18 anos</h2>
      ...
      <h2 className="text-lg font-semibold text-white">2. Tolerância zero</h2>
      ...
      <h2 className="text-lg font-semibold text-white">3. Consentimento</h2>
      ...
      <h2 className="text-lg font-semibold text-white">4. Conduta</h2>
      ...
      <h2 className="text-lg font-semibold text-white">5. Moeda virtual e itens</h2>
      ...
      <h2 className="text-lg font-semibold text-white">6. Moderação</h2>
      ...
      <h2 className="text-lg font-semibold text-white">7. Denúncias</h2>
